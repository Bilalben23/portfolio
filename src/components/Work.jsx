...
export default function Work() {
    return (
        <section className='bg-dark-default p-20' id="work">
            ...
            <div className='mt-8 flex flex-col gap-y-8'>
                {
                    projects.map((project, index) => {
                        return <div className={`flex rounded-lg overflow-clip ${index % 2 === 0 ? "flex-row" : "flex-row-reverse"}`} key={project.id}>
                            <div className="flex-1 bg-dark-100 p-7">
                                ...
                                <div className='flex flex-wrap gap-2 mb-6'>
                                    {
                                        project.techStack.map((tech, index) => <p className='px-3 py-0.5 rounded-2xl text-sm bg-dark-200 shadow' id={index}>{tech}</p>)
                                    }
                                </div>
                                <a
